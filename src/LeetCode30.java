...
public class LeetCode30 {
    /**
     * 看起来和leetcode76比较相似 用滑动窗口
     * 从0-words[0].length()-1 分别滑一次就好
     * @param s
     * @param words
     * @return
     */
...
//        leetCode30.findSubstring("ling`mindraboofooowingdingbarrwingmonkeypoundcake", new String[]{"fooo","barr","wing","ding","wing"});
        leetCode30.findSubstring("aaaaaaaa", new String[]{"aa","aa","aa"});
    }
}
